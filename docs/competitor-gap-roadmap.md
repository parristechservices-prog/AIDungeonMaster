...
| 2 | Mobile-first /play | 🟡 compact header, docked audio, safe-area, drawers | thumb-friendly, drawers, safe-area | stacked header chips, inline theme toggle, in-flow audio bar, safe-area composer | M | High | ⬜ (node env; Playwright not added) | yes (not browser-verified) | 🟡 mobile layout fixed structurally; browser verification still pending |
