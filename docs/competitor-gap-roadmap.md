...
| 2 | Mobile-first /play | ✅ compact header, docked audio, safe-area, drawers, **Playwright-verified** | thumb-friendly, drawers, safe-area | stacked header chips, inline theme toggle, in-flow audio bar, safe-area composer | M | High | ✅ `e2e/` (mobile 390×844 + desktop 1366×768) | reduced | ✅ browser-verified this pass (combat-map flow still manual) |
