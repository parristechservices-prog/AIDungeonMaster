...
export const tutorial: Scenario = {
  ...
  scenes: {
    social: {
      ...
      allowedNpcs: ['npc-kaelen'],
      allowedMonsters: [],
      allowedExits: ['training basement'],
      forbidden: ['Do not introduce danger or treasure in the training courtyard.'],
      successConditions: ['Complete a social interaction with Master Kaelen.'],
    },
    exploration: {
      ...
      allowedNpcs: ['npc-kaelen'],
      allowedMonsters: [],
      allowedExits: ['training arena'],
      forbidden: ['Do not reveal the hidden passage without a successful check.'],
      successConditions: ['Find the hidden passage.'],
    },
    combat: {
      ...
      allowedNpcs: ['npc-kaelen'],
      allowedMonsters: ['Training Construct'],
      allowedExits: ['ending'],
      forbidden: ['Do not end combat while the construct remains active.'],
