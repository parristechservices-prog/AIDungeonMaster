...
export const smugglersCove: Scenario = {
  ...
  scenes: {
    social: {
      ...
      allowedNpcs: ['npc-holt'],
      allowedMonsters: [],
      allowedExits: ['east warehouse'],
      forbidden: ['Do not reveal or award the contraband ledger here.'],
      successConditions: ['Learn the lantern code.'],
    },
    exploration: {
      ...
      allowedNpcs: [],
      allowedMonsters: [],
      allowedExits: ['smuggler tunnel'],
      forbidden: ['Do not award the contraband ledger before the ambush.'],
      successConditions: ['Find the hidden smuggler tunnel.'],
    },
    combat: {
      ...
      allowedNpcs: [],
      allowedMonsters: ['orc', 'goblin'],
      allowedExits: ['ending'],
      forbidden: ['Do not end combat while a smuggler remains active.'],
